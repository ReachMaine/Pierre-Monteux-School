 ...
 */
/* mods 
* remove the "bookmark the permalink"
*/
global $flatsome_opt;
?>
	...
	<footer class="entry-meta">
		<?php
			...
			if ( '' != $tag_list ) {
				...
				// zig - orig $meta_text = __( 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'flatsome' );
